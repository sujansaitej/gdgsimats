...
import GDSCLogoText from "../assets/images/gdgsimatslogo.png";
...
const featuresInfo = [
  ...
  },
  {
    ...
    title: "IoT & Robotics",
    description:
      "Embark on a journey into the world of Robotics and IoT with GDG. Learn about designing and automating robots and indulge into the world of IoT.",
  },
  {
    color: "#DA483B",
    indColor: "#E37272",
...
const joinDSCInfo = [
  {
    ...
    description:
      "Every year, we circulate a form for interested students to apply for joining GDG. Filling the form is the first step to get started!",
  },
  {
  ...
  },
  {
    ...
    description:
      "It doesnt end here. Be an active part of GDG and its events to gain maximum knowledge, experience, and to participate in various projects!",
  },
];
...
const FAQInfo = [
  {
    title: "Does GDG require one to have coding skills/technical expertise?",
    description:
      "Nah. GDG is composed of students who are talented in every way, including coding. Think you are good at photography or video editing? Maybe you can speak well? GDG has a place for you. Rather than your technical skills, we prefer to focus on your enthusiasm for the job!",
  },
  // {
  //   title: "Is GDG related to Google?",
  //   description:
  //     "In a way, but not completely. GDG is an initiative by Google, however, Google neither promotes nor controls GDG activities.",
  // },
  {
    title: "Can I apply if I am from from a non Computer Science department?",
    description:
      "Ofcourse! GDG aims to have a diversified committee which means that students from any department can apply to join!",
  },
];
      ...
      <div className="main-container">
        ...
        <div className="home-main-content">
          <div className="home-main-content-inner">
            <div className="home-main-content-text">
              ...
              >
                We at GDG SIMATS hope to empower young developers discover{" "}
              </p>
        ...
        <div className="dsc-def-container">
          ...
          <p className="t2 ta-left">
            ...
            <br /> Every year, GDG conducts various events and activites
        ...
        <div className="about-us-container">
          ...
          <div className="join-dsc-container">
            ...
            >
              GDG is open to any student, ranging from amateur developers who
          ...
          <div className="infographic-container">
            ...
            <p className="h3 tanText i1">
              At GDG, there's a place for everyone
            </p>
          </div>
        </div>
        ...
        <p
          ...
          style={{ marginTop: 20 }}
        >
          Join GDG SIMATS today to be a part of this! &#128512;
        </p>
