                    ...
                    <div className="events-hero">
                        ...
                        <div className="home-main-content-inner" style={{paddingTop:100}}>
                            <div className="home-main-content-text" style={{width:'100%', marginLeft: 0, paddingLeft: 0}}>
                                ...
                                <p className="h4 darkText ta-center">Resources from GDG BPDC team</p>
                                <p className="t1 ta-center" style={{marginTop: isMobile ? '20px' : '10vh'}}>Curated blogs, articles and tutorials written by GDG members</p>
